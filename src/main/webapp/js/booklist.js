    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            for (var i = 0; i < data.categories.length; i++) {
                beszurni += "<div class=\"col-lg-4\"><div class=\"panel panel-basic\"><div class=\"panel-heading\"><a href=\"./category.jsp?id=" + data.categories[i].id+"\"><h3 class=\"panel-title\"><b>" + data.categories[i].name + "</b></h3></a></div><div class=\"panel-body\"><div class=\"list-group\">";
                var talalt = 0;
